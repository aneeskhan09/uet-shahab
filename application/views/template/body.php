							...
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
									...
									<tr class="odd gradeX">
                                        ...
                                        <td>
                                        	<?php if($row->STATUS==1){?>
											<div class="label label-primary"> Initiated...</div>
                                            <?php }else{?>
                                        ...
                                        <div class="btn-group btn-sm">
                                            ...
                                            <?php }else{?>
                                            <a href="<?=base_url();?>Welcome/cancel_invoice/<?=$row->INVOICE_NO;?>" onClick="return confirm('Are You Sure ?')" class="btn btn-danger">Cancel</a>
                                            <?php }?>
                                        </div>	
                                            </td>
