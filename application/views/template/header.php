...
-->
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="divider"></li>
									<li><a href="<?=base_url();?>welcome/logout"><i class="dropdown-icon fa fa-power-off"></i>&nbsp;&nbsp;Log Out</a></li>
								</ul>
							</li>
						</ul> <!-- / .navbar-nav -->
					</div> <!-- / .right -->
	...
	<div id="main-menu" role="navigation">
		<div id="main-menu-inner">
			...
			<ul class="navigation">
				...
				<li class="mm-dropdown">
					<a href="#"><i class="menu-icon fa fa-th"></i><span class="mm-text">Current Issue</span></a>
					<ul>
                    	<li>
							<a tabindex="-1" href="<?=base_url('Welcome/Invoice_list')?>"><span class="mm-text menu-icon fa  fa-minus-square"></span> InvoiceList</a>
						</li>
						<li>
							<a tabindex="-1" href="<?=base_url('Welcome/Current_issue')?>"><span class="mm-text menu-icon fa  fa-minus-square"></span>Cancel Invoice</a>
						</li>
						<li>
							<a tabindex="-1" href="<?=base_url('Welcome/cancelled_invoices')?>"><i class="menu-icon fa fa-th-list"></i><span class="mm-text">Cancelled Invoices</span></a>
						</li>
                        <li>
							<a tabindex="-1" href="<?=base_url('Welcome/cancel_invoice_student_wise')?>"><i class="menu-icon fa fa-th-list"></i><span class="mm-text">Cancel Invoice Student Wise</span></a>
						</li>
					</ul>
				</li>
				<li>
