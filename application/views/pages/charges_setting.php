...
-->
              ...
              <script>
					...
					///////////////////////////////////////////////////////////////
					function get_value_charges(id)
					{
						
						$.get('<?=base_url()?>Welcome/update_charges?id='+id+'',function(data){
							//alert(data);
							$('#datatab').html(data);
						})
					}
  ...
  var docprint=window.open("","",disp_setting); 
   ...
   document.getElementById(this).style.visibility='hidden';
	...
	<div class="row">
        ...
        <legend class=""> Create New Charge</legend>
        <form class="form" method="post" action="<?=base_url('welcome/create_charges');?>">
        	
            	<div class="col-sm-12">
                			<label>Charge Type name</label><br>
							<input type="text" class="form-control" name="chargetype" placeholder="Please Enter Charge type name">
						
       					<br>
						<!-- Primary -->
							<label> Charges</label>
							<input class="form-control" type="number" name="charge" placeholder="Enter Charge Value">
                        	<br>
					...
					<div class="panel-body">
    					 <div class="table-success">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
								...
								<tbody>
                                	<?php $a = 1;foreach($charges as $row):?>
									<tr class="odd gradeX">
										<td><?=$a++?></td>
                                        ...
                                        <div class="btn-group btn-sm">
                                            <button href="#" value="<?=$row->CHARGE_ID;?>" onClick="get_value_charges(this.value)" class="btn btn-info" data-toggle="modal" data-target=".bs-example-modal-lg"><span class="fa fa-eye"></span>EDIT</button>
                                            
                                            <a href="<?=base_url();?>Welcome/delete_charges/<?=$row->CHARGE_ID;?>" onClick="return confirm('Are You Sure ?')" class="btn btn-danger">DELETE</a>
